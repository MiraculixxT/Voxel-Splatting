...
void GUIRenderer::RenderStatsOverview(const double& vertexCount) {
    ...
    ImGui::Text("FPS: %.1f | Frame Time: %.3fms | Verts: %d", ImGui::GetIO().Framerate, 1000.0f / ImGui::GetIO().Framerate, vertexCount);
